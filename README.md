...
[![CI](https://github.com/rajiviyer/era-v5-session06-training-data-system/actions/workflows/ci.yml/badge.svg)](https://github.com/rajiviyer/era-v5-session06-training-data-system/actions/workflows/ci.yml)
...
Re-run `uv run python scripts/run_demo.py` to regenerate `submission_artifacts/`
before submitting if you change the implementation.
...
`submission_artifacts/` is committed from the latest demo run and can be regenerated
